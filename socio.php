...
class Socio extends Persona
{
    ...
    {
        $this->fechaBaja = date("d/m/Y", strtotime($fecha));
        $this->bActivo = false; // Baja lógica
    }

    public function imprimir()
    {
        // Aquí puedes definir cómo quieres imprimir la información del socio
        echo "Socio: " . $this->nombre . "<br>";
        echo "DNI: " . $this->dni . "<br>";
        echo "Correo: " . $this->correo . "<br>";
        echo "Celular: " . $this->celular . "<br>";
        echo "Fecha de alta: " . $this->fechaAlta . "<br>";
        echo "Activo: " . ($this->bActivo ? "Sí" : "No") . "<br>";
        if (!$this->bActivo) {
            echo "Fecha de baja: " . $this->fechaBaja . "<br>";
        }
    }
}
